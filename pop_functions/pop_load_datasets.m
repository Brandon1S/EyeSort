...
% DESCRIPTION: Function is designed to allow the user to load in a single dataset or a directory of datasets to prepare for the rest of the EyeSort pipeline.
    ...
    uilist = { ...
        ...
        {'Style', 'text', 'string', 'Batch process all dataset(s) in directory:', 'FontWeight', 'bold', 'FontSize', 12}, ...
        {}, ...
        ...
        {'Style', 'text', 'string', 'Output Directory (for processed datasets):', 'FontWeight', 'bold', 'FontSize', 12}, ...
        {}, ...
